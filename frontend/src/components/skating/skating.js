    ...
    <div className={css.skating_container}>
      <div className={css.skating_cont}>
        ...
        <div className={css.content_cont}>
          <div className={`${css.main_text} ${css.text}`}>
          ...
          <iframe className={css.video} width="560" height="315" src="https://www.youtube.com/embed/xM8uQir3SOw" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
